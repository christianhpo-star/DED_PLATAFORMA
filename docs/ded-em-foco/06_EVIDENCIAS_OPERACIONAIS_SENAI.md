...
O relatório registra, na conferência de fechamento do DED+, que ainda restavam **duas turmas pendentes por questões com o SENAI e troca de professores**, em fase de regularização pela equipe escolar.
...
Essa evidência é coerente com a anomalia encontrada nos registros do 2º ano de Sistemas de Energia Renovável:

- total T1: 481;
- benchmark global proporcional: 594;
- diferença: -113;
- bloco técnico SER III+IV: 62;
