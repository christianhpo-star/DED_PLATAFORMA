...
const refLabels = {EM_REG_1:'1º EM · Regular noturno',EM_REG_2:'2º EM · Regular noturno',EM_REG_3:'3º EM · Regular noturno',EM_INT_1:'1º EM · Integral',EM_INT_2:'2º EM · Integral',EM_INT_3:'3º EM · Integral',EM_INT_2_AUT:'2º EM · Integral · Automação Industrial',EM_INT_2_DS:'2º EM · Integral · Desenvolvimento de Sistemas',EM_INT_2_FAB:'2º EM · Integral · Fabricação Mecânica',EM_INT_2_QUI:'2º EM · Integral · Química / Produção Industrial',EM_INT_2_SER:'2º EM · Integral · Sistemas de Energia Renovável',EM_INT_3_AUT:'3º EM · Integral · Automação Industrial',EM_INT_3_DS:'3º EM · Integral · Desenvolvimento de Sistemas',EM_INT_3_FAB:'3º EM · Integral · Fabricação Mecânica',EM_INT_3_QUI:'3º EM · Integral · Química / Produção Industrial',EM_INT_3_SER:'3º EM · Integral · Sistemas de Energia Renovável',EM_INT_3_INFO:'3º EM · Integral · Informática',EM_INT_3_SEG:'3º EM · Integral · Segurança do Trabalho'};
function offerFilterLabel(key){if(key==='REGULAR_NOTURNO')return 'Regular · noturno';if(key==='INTEGRAL')return 'Integral · todas';if(key==='BILINGUE')return 'Integral · bilíngue';if(key.startsWith('TEC_'))return 'Técnico · '+(COURSE_LABELS[key.slice(4)]||key.slice(4));return key;}
function rowOfferTags(r){const tags=[];if(r.offer==='REGULAR_NOTURNO')tags.push('REGULAR_NOTURNO');if(String(r.bucket||'').startsWith('EM_INT_'))tags.push('INTEGRAL');if(r.bilingual)tags.push('BILINGUE');if(r.courseKey)tags.push('TEC_'+r.courseKey);return tags;}
function rowMatchesOfferFilter(r,key){return !key||rowOfferTags(r).includes(key);}
function offerFilterOptions(rows){const keys=unique(rows.flatMap(rowOfferTags)),rank=k=>k==='REGULAR_NOTURNO'?0:k==='INTEGRAL'?1:k==='BILINGUE'?2:3;return keys.sort((a,b)=>rank(a)-rank(b)||offerFilterLabel(a).localeCompare(offerFilterLabel(b),'pt-BR')).map(k=>[k,offerFilterLabel(k)]);}
const iconPaths = {
